...
import { InputComponent as Input } from '@/app/ui/form/input';
...
export default function LoginForm() {
  ...
  return (
    <form
      action={dispatch}
      className="space-y-3 rounded-lg bg-lightPaper dark:bg-darkPaper"
      style={{
        boxShadow:
...
const SubmitButton = ({ onClick }: SubmitButtonProps) => {
  ...
  return (
    ...
    >
      {!pending && (
        <>
          Ingresar <ArrowRightIcon className="ml-auto h-5 w-5 text-white" />
        </>
      )}
    </Button>
  );
